...
(and (<= 0.821539237 y0) 
(and (<= y0 1.5) 
(and (<= x0 (- 3.7904610174 0.7961304712)) 
(and (>= x0 0) 
(and (<= (+ x1 0.052921994) z) 
(and (<= 0.6646492241 y1) 
(and (<= y1 1.5) 
(and (<= x1 (- 3.7904610174 0.052921994)) 
(and (>= x1 0) 
(and (<= (+ x2 0.268041027) z) 
(and (<= 0.5664855651 y2) 
(and (<= y2 1.5) 
(and (<= x2 (- 3.7904610174 0.268041027)) 
(and (>= x2 0) 
(and (<= (+ x3 0.8543307449) z) 
(and (<= 0.5450729955 y3) 
(and (<= y3 1.5) 
(and (<= x3 (- 3.7904610174 0.8543307449)) 
(and (>= x3 0) 
(and (<= (+ x4 0.9198462908) z) 
(and (<= 0.5440541188 y4) 
(and (<= y4 1.5) 
(and (<= x4 (- 3.7904610174 0.9198462908)) 
(and (>= x4 0) 
(and (<= (+ x5 0.1999795429) z) 
(and (<= 0.4670985854 y5) 
(and (<= y5 1.5) 
(and (<= x5 (- 3.7904610174 0.1999795429)) 
(and (>= x5 0) 
(and (<= (+ x6 0.2292161943) z) 
(and (<= 0.2944867731 y6) 
(and (<= y6 1.5) 
(and (<= x6 (- 3.7904610174 0.2292161943)) 
(and (>= x6 0) 
(and (<= (+ x7 0.6905940709) z) 
(and (<= 0.2319818513 y7) 
(and (<= y7 1.5) 
(and (<= x7 (- 3.7904610174 0.6905940709)) 
(and (>= x7 0) 
(and (<= (+ x8 0.9521124835) z) 
(and (<= 0.0670375999 y8) 
(and (<= y8 1.5) 
(and (<= x8 (- 3.7904610174 0.9521124835)) 
(and (>= x8 0) 
(and (<= c 3.7904610174) 
