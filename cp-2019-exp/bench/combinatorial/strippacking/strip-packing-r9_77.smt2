...
(and (<= 0.6740938559 y0) 
(and (<= y0 1.5) 
(and (<= x0 (- 2.8169773327 0.2008846309)) 
(and (>= x0 0) 
(and (<= (+ x1 0.884937463) z) 
(and (<= 0.5237632248 y1) 
(and (<= y1 1.5) 
(and (<= x1 (- 2.8169773327 0.884937463)) 
(and (>= x1 0) 
(and (<= (+ x2 0.4421052709) z) 
(and (<= 0.3886669335 y2) 
(and (<= y2 1.5) 
(and (<= x2 (- 2.8169773327 0.4421052709)) 
(and (>= x2 0) 
(and (<= (+ x3 0.8545285347) z) 
(and (<= 0.3693494151 y3) 
(and (<= y3 1.5) 
(and (<= x3 (- 2.8169773327 0.8545285347)) 
(and (>= x3 0) 
(and (<= (+ x4 0.8273201526) z) 
(and (<= 0.186644739 y4) 
(and (<= y4 1.5) 
(and (<= x4 (- 2.8169773327 0.8273201526)) 
(and (>= x4 0) 
(and (<= (+ x5 0.7595064849) z) 
(and (<= 0.1774441306 y5) 
(and (<= y5 1.5) 
(and (<= x5 (- 2.8169773327 0.7595064849)) 
(and (>= x5 0) 
(and (<= (+ x6 0.4926851019) z) 
(and (<= 0.1643063397 y6) 
(and (<= y6 1.5) 
(and (<= x6 (- 2.8169773327 0.4926851019)) 
(and (>= x6 0) 
(and (<= (+ x7 0.4993802234) z) 
(and (<= 0.1488811651 y7) 
(and (<= y7 1.5) 
(and (<= x7 (- 2.8169773327 0.4993802234)) 
(and (>= x7 0) 
(and (<= (+ x8 0.9716487539) z) 
(and (<= 0.0428240709 y8) 
(and (<= y8 1.5) 
(and (<= x8 (- 2.8169773327 0.9716487539)) 
(and (>= x8 0) 
(and (<= c 2.8169773327) 
