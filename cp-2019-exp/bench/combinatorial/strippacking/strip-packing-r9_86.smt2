...
(and (<= 0.9689662639 y0) 
(and (<= y0 1.5) 
(and (<= x0 (- 2.8389350884 0.208474064)) 
(and (>= x0 0) 
(and (<= (+ x1 0.9879818501) z) 
(and (<= 0.9303199373 y1) 
(and (<= y1 1.5) 
(and (<= x1 (- 2.8389350884 0.9879818501)) 
(and (>= x1 0) 
(and (<= (+ x2 0.2405121162) z) 
(and (<= 0.7915469083 y2) 
(and (<= y2 1.5) 
(and (<= x2 (- 2.8389350884 0.2405121162)) 
(and (>= x2 0) 
(and (<= (+ x3 0.162258029) z) 
(and (<= 0.6825202276 y3) 
(and (<= y3 1.5) 
(and (<= x3 (- 2.8389350884 0.162258029)) 
(and (>= x3 0) 
(and (<= (+ x4 0.5395635962) z) 
(and (<= 0.4191186147 y4) 
(and (<= y4 1.5) 
(and (<= x4 (- 2.8389350884 0.5395635962)) 
(and (>= x4 0) 
(and (<= (+ x5 0.4977666904) z) 
(and (<= 0.3684083946 y5) 
(and (<= y5 1.5) 
(and (<= x5 (- 2.8389350884 0.4977666904)) 
(and (>= x5 0) 
(and (<= (+ x6 0.1786220318) z) 
(and (<= 0.182897863 y6) 
(and (<= y6 1.5) 
(and (<= x6 (- 2.8389350884 0.1786220318)) 
(and (>= x6 0) 
(and (<= (+ x7 0.9042003677) z) 
(and (<= 0.1803553968 y7) 
(and (<= y7 1.5) 
(and (<= x7 (- 2.8389350884 0.9042003677)) 
(and (>= x7 0) 
(and (<= (+ x8 0.8973784679) z) 
(and (<= 0.136219833 y8) 
(and (<= y8 1.5) 
(and (<= x8 (- 2.8389350884 0.8973784679)) 
(and (>= x8 0) 
(and (<= c 2.8389350884) 
