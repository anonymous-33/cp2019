...
(and (<= 0.9323025321 y0) 
(and (<= y0 1.5) 
(and (<= x0 (- 2.0316108972 0.6253124653)) 
(and (>= x0 0) 
(and (<= (+ x1 0.5794344417) z) 
(and (<= 0.7690638148 y1) 
(and (<= y1 1.5) 
(and (<= x1 (- 2.0316108972 0.5794344417)) 
(and (>= x1 0) 
(and (<= (+ x2 0.4430145239) z) 
(and (<= 0.6153485426 y2) 
(and (<= y2 1.5) 
(and (<= x2 (- 2.0316108972 0.4430145239)) 
(and (>= x2 0) 
(and (<= (+ x3 0.5263281118) z) 
(and (<= 0.4767205246 y3) 
(and (<= y3 1.5) 
(and (<= x3 (- 2.0316108972 0.5263281118)) 
(and (>= x3 0) 
(and (<= (+ x4 0.034080812) z) 
(and (<= 0.440244086 y4) 
(and (<= y4 1.5) 
(and (<= x4 (- 2.0316108972 0.034080812)) 
(and (>= x4 0) 
(and (<= (+ x5 0.7927831782) z) 
(and (<= 0.2409534635 y5) 
(and (<= y5 1.5) 
(and (<= x5 (- 2.0316108972 0.7927831782)) 
(and (>= x5 0) 
(and (<= (+ x6 0.7890897911) z) 
(and (<= 0.0703414039 y6) 
(and (<= y6 1.5) 
(and (<= x6 (- 2.0316108972 0.7890897911)) 
(and (>= x6 0) 
(and (<= (+ x7 0.2323399369) z) 
(and (<= 0.0113939723 y7) 
(and (<= y7 1.5) 
(and (<= x7 (- 2.0316108972 0.2323399369)) 
(and (>= x7 0) 
(and (<= (+ x8 0.3567800875) z) 
(and (<= 0.0074030491 y8) 
(and (<= y8 1.5) 
(and (<= x8 (- 2.0316108972 0.3567800875)) 
(and (>= x8 0) 
(and (<= c 2.0316108972) 
