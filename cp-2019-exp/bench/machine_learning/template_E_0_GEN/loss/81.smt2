...
;; cost: image coverage
    ...
    (assert-soft (not horizontal_1) :weight (- 0.0 (/ 3361211974391041.0 9007199254740992.0)) :id cost_sum)
    (assert-soft (not horizontal_1) :weight (- 0.0 (/ 3361211974391041.0 9007199254740992.0)) :id cost_sum)
    (assert-soft (not horizontal_2) :weight (/ 4798473942598849.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not horizontal_2) :weight (/ 4798473942598849.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not horizontal_3) :weight (- 0.0 (/ 5760448744778011.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not horizontal_3) :weight (- 0.0 (/ 5760448744778011.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not horizontal_4) :weight (/ 6560194401877819.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not horizontal_4) :weight (/ 6560194401877819.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not horizontal_5) :weight (- 0.0 (/ 5760448744778011.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not horizontal_5) :weight (- 0.0 (/ 5760448744778011.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_1) :weight (/ 27526885315491.0 281474976710656.0) :id cost_sum)
    (assert-soft (not increasing_1) :weight (/ 27526885315491.0 281474976710656.0) :id cost_sum)
    (assert-soft (not increasing_2) :weight (- 0.0 (/ 4960703137906317.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_2) :weight (- 0.0 (/ 4960703137906317.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_3) :weight (/ 1599491263971503.0 2251799813685248.0) :id cost_sum)
    (assert-soft (not increasing_3) :weight (/ 1599491263971503.0 2251799813685248.0) :id cost_sum)
    (assert-soft (not increasing_4) :weight (- 0.0 (/ 5320018629958269.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_4) :weight (- 0.0 (/ 5320018629958269.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_5) :weight (/ 730195414664711.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not increasing_5) :weight (/ 730195414664711.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not decreasing_1) :weight (/ 4960703288590657.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_1) :weight (/ 4960703288590657.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_2) :weight (/ 5122932333213783.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not decreasing_2) :weight (/ 5122932333213783.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not decreasing_3) :weight (/ 2561466216835005.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not decreasing_3) :weight (/ 2561466216835005.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not decreasing_4) :weight (/ 8159685716077437.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_4) :weight (/ 8159685716077437.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_5) :weight (/ 2839667086119167.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not decreasing_5) :weight (/ 2839667086119167.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not right_1) :weight (- 0.0 (/ 5841563618686369.0 9007199254740992.0)) :id cost_sum)
    (assert-soft (not right_1) :weight (- 0.0 (/ 5841563618686369.0 9007199254740992.0)) :id cost_sum)
    (assert-soft (not right_2) :weight (/ 4079842757582491.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not right_2) :weight (/ 4079842757582491.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not right_3) :weight (- 0.0 (/ 3280097301395137.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_3) :weight (- 0.0 (/ 3280097301395137.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_4) :weight (/ 2080478715289197.0 2251799813685248.0) :id cost_sum)
    (assert-soft (not right_4) :weight (/ 2080478715289197.0 2251799813685248.0) :id cost_sum)
    (assert-soft (not right_5) :weight (- 0.0 (/ 3280097301395137.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_5) :weight (- 0.0 (/ 3280097301395137.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not head_to_head_1_2) :weight (/ 6560194200965365.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_1_2) :weight (/ 6560194200965365.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_2_3) :weight (/ 6397965457710921.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not head_to_head_2_3) :weight (/ 6397965457710921.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not head_to_head_3_4) :weight (/ 4242072003118071.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_3_4) :weight (/ 4242072003118071.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_4_5) :weight (/ 4960703087678203.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_4_5) :weight (/ 4960703087678203.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_tail_1_2) :weight (/ 8159685916989891.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not head_to_tail_1_2) :weight (/ 8159685916989891.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not head_to_tail_2_3) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not head_to_tail_2_3) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not head_to_tail_3_4) :weight (/ 509980332140783.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not head_to_tail_3_4) :weight (/ 509980332140783.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not head_to_tail_4_5) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not head_to_tail_4_5) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not tail_to_head_1_2) :weight (/ 1761720559735197.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_1_2) :weight (/ 1761720559735197.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_2_3) :weight (/ 2642580889830909.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_2_3) :weight (/ 2642580889830909.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_3_4) :weight (/ 8159686117902345.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not tail_to_head_3_4) :weight (/ 8159686117902345.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not tail_to_head_4_5) :weight (/ 4079842757582491.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_4_5) :weight (/ 4079842757582491.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_tail_1_2) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_1_2) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_2_3) :weight (/ 3280097050254569.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not tail_to_tail_2_3) :weight (/ 3280097050254569.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not tail_to_tail_3_4) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_3_4) :weight (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_4_5) :weight (/ 6722423747869627.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not tail_to_tail_4_5) :weight (/ 6722423747869627.0 18014398509481984.0) :id cost_sum)
    ...
    (assert-soft (not covers_30) :weight 1.0 :id FEAT_cover)
       ...
       ;; delta components
(assert (and (ite (<= FEAT_cover 22.0 )
             (= delta_FEAT_cover (- 22.0 FEAT_cover ))
             (= delta_FEAT_cover (- FEAT_cover 22.0 )))
        (>= delta_FEAT_cover 0.0)
        (<= delta_FEAT_cover 31.0) ))
    (assert-soft (not (or (and horizontal_1 (= (- 1.0) 1.0 )) (and (not horizontal_1) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    ...
    (assert-soft (not (or (and horizontal_3 (= (- 1.0) 1.0 )) (and (not horizontal_3) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    ...
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and increasing_1 (= (- 1.0) (- 0.0 1.0) )) (and (not increasing_1) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and increasing_2 (= (- 1.0) 1.0 )) (and (not increasing_2) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and increasing_3 (= (- 1.0) (- 0.0 1.0) )) (and (not increasing_3) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and increasing_4 (= (- 1.0) 1.0 )) (and (not increasing_4) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    ...
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and decreasing_4 (= (- 1.0) (- 0.0 1.0) )) (and (not decreasing_4) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and decreasing_5 (= (- 1.0) (- 0.0 1.0) )) (and (not decreasing_5) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and right_1 (= (- 1.0) 1.0 )) (and (not right_1) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and right_2 (= (- 1.0) (- 0.0 1.0) )) (and (not right_2) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and right_3 (= (- 1.0) 1.0 )) (and (not right_3) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and right_4 (= (- 1.0) (- 0.0 1.0) )) (and (not right_4) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    ...
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and tail_to_tail_3_4 (= (- 1.0) 1.0 )) (and (not tail_to_tail_3_4) (= 1.0 1.0)))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 1.0)) :weight 1.0 :id delta_sum)
    (assert-soft (not (or (and tail_to_tail_4_5 (= (- 1.0) (- 0.0 1.0) )) (and (not tail_to_tail_4_5) (= 1.0 (- 0.0 1.0) )))) :weight 2.0 :id delta_sum)
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
                (assert (= cost (+ (* (- 0.0 (/ 1627730914113893.0 562949953421312.0)) FEAT_cover) cost_sum )))
...
(= delta (+ delta_FEAT_cover delta_sum))
       ;; separation
                (= separation (- cost (+ delta (- 0.0 (/ 3361211974391041.0 9007199254740992.0)) (/ 4798473942598849.0 9007199254740992.0) (- 0.0 (/ 5760448744778011.0 4503599627370496.0)) (/ 6560194401877819.0 9007199254740992.0) (- 0.0 (/ 5760448744778011.0 4503599627370496.0)) (/ 27526885315491.0 281474976710656.0) (- 0.0 (/ 4960703137906317.0 4503599627370496.0)) (/ 1599491263971503.0 2251799813685248.0) (- 0.0 (/ 5320018629958269.0 4503599627370496.0)) (/ 730195414664711.0 1125899906842624.0) (/ 4960703288590657.0 18014398509481984.0) (/ 5122932333213783.0 9007199254740992.0) (/ 2561466216835005.0 4503599627370496.0) (/ 8159685716077437.0 18014398509481984.0) (/ 2839667086119167.0 4503599627370496.0) (- 0.0 (/ 5841563618686369.0 9007199254740992.0)) (/ 4079842757582491.0 9007199254740992.0) (- 0.0 (/ 3280097301395137.0 4503599627370496.0)) (/ 2080478715289197.0 2251799813685248.0) (- 0.0 (/ 3280097301395137.0 4503599627370496.0)) (/ 6560194200965365.0 9007199254740992.0) (/ 6397965457710921.0 18014398509481984.0) (/ 4242072003118071.0 9007199254740992.0) (/ 4960703087678203.0 9007199254740992.0) (/ 8159685916989891.0 18014398509481984.0) (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) (/ 509980332140783.0 1125899906842624.0) (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) (/ 1761720559735197.0 9007199254740992.0) (/ 2642580889830909.0 9007199254740992.0) (/ 8159686117902345.0 18014398509481984.0) (/ 4079842757582491.0 9007199254740992.0) (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) (/ 3280097050254569.0 4503599627370496.0) (- 0.0 (/ 3100439429798877.0 2251799813685248.0)) (/ 6722423747869627.0 18014398509481984.0) )))
...
(= py_17 (/ 7.0 16.0))
(= py_18 (/ 7.0 16.0))
(= py_19 (/ 7.0 16.0)) ;; placeholder for x
