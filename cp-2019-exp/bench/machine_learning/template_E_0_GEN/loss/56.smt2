...
;; cost: image coverage
    ...
    (assert-soft (not horizontal_1) :weight (- 0.0 (/ 293600849373493.0 1125899906842624.0)) :id cost_sum)
    (assert-soft (not horizontal_1) :weight (- 0.0 (/ 293600849373493.0 1125899906842624.0)) :id cost_sum)
    (assert-soft (not horizontal_2) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not horizontal_2) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not horizontal_3) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not horizontal_3) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not horizontal_4) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not horizontal_4) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not horizontal_5) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not horizontal_5) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_1) :weight (/ 14992649901735.0 73786976294838206464.0) :id cost_sum)
    (assert-soft (not increasing_1) :weight (/ 14992649901735.0 73786976294838206464.0) :id cost_sum)
    (assert-soft (not increasing_2) :weight (- 0.0 (/ 4697607184424783.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_2) :weight (- 0.0 (/ 4697607184424783.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_3) :weight (/ 4697604439188595.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not increasing_3) :weight (/ 4697604439188595.0 4503599627370496.0) :id cost_sum)
    (assert-soft (not increasing_4) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_4) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not increasing_5) :weight (/ 4697606269346053.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not increasing_5) :weight (/ 4697606269346053.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not decreasing_1) :weight (/ 4697609929660971.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_1) :weight (/ 4697609929660971.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_2) :weight (/ 4697609929660971.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_2) :weight (/ 4697609929660971.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not decreasing_3) :weight (/ 293600849373493.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not decreasing_3) :weight (/ 293600849373493.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not decreasing_4) :weight (/ 4697606269346053.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not decreasing_4) :weight (/ 4697606269346053.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not decreasing_5) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not decreasing_5) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not right_1) :weight (- 0.0 (/ 2348805879909215.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_1) :weight (- 0.0 (/ 2348805879909215.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_2) :weight (/ 4697604439188595.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not right_2) :weight (/ 4697604439188595.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not right_3) :weight (- 0.0 (/ 3523206532166999.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_3) :weight (- 0.0 (/ 3523206532166999.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_4) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not right_4) :weight (/ 880801175502385.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not right_5) :weight (- 0.0 (/ 3523206532166999.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not right_5) :weight (- 0.0 (/ 3523206532166999.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not head_to_head_1_2) :weight (/ 7046405743704163.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_1_2) :weight (/ 7046405743704163.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_2_3) :weight (/ 587201012437939.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not head_to_head_2_3) :weight (/ 587201012437939.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not head_to_head_3_4) :weight (/ 4697606269346053.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not head_to_head_3_4) :weight (/ 4697606269346053.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not head_to_head_4_5) :weight (/ 4697606269346053.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_head_4_5) :weight (/ 4697606269346053.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not head_to_tail_1_2) :weight (/ 587201012437939.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not head_to_tail_1_2) :weight (/ 587201012437939.0 1125899906842624.0) :id cost_sum)
    (assert-soft (not head_to_tail_2_3) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not head_to_tail_2_3) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not head_to_tail_3_4) :weight (/ 146800081532223.0 281474976710656.0) :id cost_sum)
    (assert-soft (not head_to_tail_3_4) :weight (/ 146800081532223.0 281474976710656.0) :id cost_sum)
    (assert-soft (not head_to_tail_4_5) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not head_to_tail_4_5) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not tail_to_head_1_2) :weight (/ 14992649901735.0 73786976294838206464.0) :id cost_sum)
    (assert-soft (not tail_to_head_1_2) :weight (/ 14992649901735.0 73786976294838206464.0) :id cost_sum)
    (assert-soft (not tail_to_head_2_3) :weight (/ 14992649901735.0 36893488147419103232.0) :id cost_sum)
    (assert-soft (not tail_to_head_2_3) :weight (/ 14992649901735.0 36893488147419103232.0) :id cost_sum)
    (assert-soft (not tail_to_head_3_4) :weight (/ 4697609929660971.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_3_4) :weight (/ 4697609929660971.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_4_5) :weight (/ 4697604439188595.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_head_4_5) :weight (/ 4697604439188595.0 9007199254740992.0) :id cost_sum)
    (assert-soft (not tail_to_tail_1_2) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_1_2) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_2_3) :weight (/ 440400244596669.0 562949953421312.0) :id cost_sum)
    (assert-soft (not tail_to_tail_2_3) :weight (/ 440400244596669.0 562949953421312.0) :id cost_sum)
    (assert-soft (not tail_to_tail_3_4) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_3_4) :weight (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) :id cost_sum)
    (assert-soft (not tail_to_tail_4_5) :weight (/ 4697609929660971.0 18014398509481984.0) :id cost_sum)
    (assert-soft (not tail_to_tail_4_5) :weight (/ 4697609929660971.0 18014398509481984.0) :id cost_sum)
...
(assert (and (ite (<= FEAT_cover 22.0 )
    ...
    (assert-soft (not (= 0.0 (- 0.0 1.0) )) :weight 1.0 :id delta_sum)
                (assert (= cost (+ (* (- 0.0 (/ 3082811892427547.0 1125899906842624.0)) FEAT_cover) cost_sum )))
...
(= delta (+ delta_FEAT_cover delta_sum))
       ;; separation
                (= separation (- cost (+ delta (- 0.0 (/ 293600849373493.0 1125899906842624.0)) (/ 880801175502385.0 1125899906842624.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 880801175502385.0 1125899906842624.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 14992649901735.0 73786976294838206464.0) (- 0.0 (/ 4697607184424783.0 4503599627370496.0)) (/ 4697604439188595.0 4503599627370496.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 4697606269346053.0 9007199254740992.0) (/ 4697609929660971.0 18014398509481984.0) (/ 4697609929660971.0 18014398509481984.0) (/ 293600849373493.0 1125899906842624.0) (/ 4697606269346053.0 9007199254740992.0) (/ 880801175502385.0 1125899906842624.0) (- 0.0 (/ 2348805879909215.0 4503599627370496.0)) (/ 4697604439188595.0 9007199254740992.0) (- 0.0 (/ 3523206532166999.0 4503599627370496.0)) (/ 880801175502385.0 1125899906842624.0) (- 0.0 (/ 3523206532166999.0 4503599627370496.0)) (/ 7046405743704163.0 9007199254740992.0) (/ 587201012437939.0 1125899906842624.0) (/ 4697606269346053.0 18014398509481984.0) (/ 4697606269346053.0 9007199254740992.0) (/ 587201012437939.0 1125899906842624.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 146800081532223.0 281474976710656.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 14992649901735.0 73786976294838206464.0) (/ 14992649901735.0 36893488147419103232.0) (/ 4697609929660971.0 9007199254740992.0) (/ 4697604439188595.0 9007199254740992.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 440400244596669.0 562949953421312.0) (- 0.0 (/ 5872007836682567.0 4503599627370496.0)) (/ 4697609929660971.0 18014398509481984.0) )))
